#IIS LOG Rotator-
# VARIABLES
#$LogPath_Disk="Z:\IISLOG\"
#$LogPath_Folder="W3SVC32"
$LogPath = $LogPath_Disk + $LogPath_Folder
#$DeletionRetention = -180
#$CompressedRetention = -30
#$TasinacakKlasor= "\\Sunucu\Folder"

#requires -Version 3

#Setting Global variables

$Global:logDir = $LogPath #Location of IIS logs
$Global:archDir = $TasinacakKlasor #archive directory location
$Global:logFile = 'Z:\maintain-iislogs.txt'
$global:logTime = Get-Date -Format 'dd-MM-yyyy_hh-mm-ss'
